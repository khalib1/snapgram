...
if(isLoggedIn){
 ...
 return(
   ...
   <Form {...form}>
    <div className="sm:w-490 flex-center flex-col">
     <img src="/assets/images/logo2.png" alt="logo" className="w-10"/>
     <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12">Create a new account</h2>
     <p className="text-light-3 small-medium md:base-regular">To use SnapTalk enter your details</p>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full mt-4">
        ...
        <p className="text-small-regular text-align-2 text-center mt-2">
